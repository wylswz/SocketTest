...
public class SocketTestClient extends JPanel {
    ...
    private JButton sendUTFButton = new JButton("Send as UTF");
    ...
    public SocketTestClient(final JFrame parent) {
        ...
        sendUTFButton.setEnabled(false);
        sendUTFButton.setToolTipText("Send text to host");
        ...
        ActionListener sendUTFListener = new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                String msg = sendField.getText();
                if(!msg.equals(""))
                    sendUTFMessage(msg);
        ...
        sendUTFButton.addActionListener(sendUTFListener);
        sendField.addActionListener(sendListener);
        sendPanel.add(sendButton, gbc);
        gbc.gridx=3;
        sendPanel.add(sendUTFButton, gbc);
        sendPanel.setBorder(
                new CompoundBorder(
    ...
    public void sendUTFMessage(String s) {
        setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        try	{
